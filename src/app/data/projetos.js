...
export const projetos = [
  // ---------- COZINHAS PLANEJADAS ----------
  // Ordenados do projeto visualmente mais forte para o menos, porque a
  // primeira foto de cada aba e a que abre no visor.
  {
  ...
  // ---------- COZINHAS MODULADAS (aparecem apenas na aba Modulados) ----------
  {
